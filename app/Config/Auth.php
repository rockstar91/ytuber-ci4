...
class Auth extends \Myth\Auth\Config\Auth
{
    ...
    public $views = [
        'login' => 'App\Views\Auth\login_codebase',
        'register' => 'App\Views\Auth\register_codebase',
        'forgot' => 'App\Views\Auth\forgot_codebase',
        'reset' => 'App\Views\Auth\reset_codebase',
        'emailForgot' => 'App\Views\Auth\emails\forgot',
        'emailActivation' => 'App\Views\Auth\emails\activation',
        'termsModal' => 'App\Views\Auth\_terms_modal'
    ];
    ...
    public $viewLayout = 'App\Views\Auth\layout_codebase';
    ...
    //--------------------------------------------------------------------
    // Path of Google config
    //--------------------------------------------------------------------
    // Json file path with Google authentication credentials = ''
    //
    public $googleConfigPath = ROOTPATH . 'client_secret_1049057798715-6hrrd7emfl9fecnfa0nnrsq3d860cbov.apps.googleusercontent.com.json';
    ...
    //--------------------------------------------------------------------
    // Redirect URL for Google authentication
    //--------------------------------------------------------------------
    // URL for redirect to Google authentication form
    //
    public $googleRedirectURL = 'http://localhost/auth/googleLogin';

    //--------------------------------------------------------------------
    // Access type to Google authentication
    //--------------------------------------------------------------------
    //
    //
    public $googleAccessType = 'offline';

    //--------------------------------------------------------------------
    // Specifies any string value that your application uses to maintain state between
    // your authorization request and the authorization server's response. The server returns
    // the exact value that you send as a name=value pair in the URL fragment identifier
    // (#) of the redirect_uri after the user consents to or denies your application's access request.
    //--------------------------------------------------------------------
    //
    //
    public $googleState = 'offline';

    //--------------------------------------------------------------------
    // Redirect URL for VK authentication
    //--------------------------------------------------------------------
    // URL for redirect to VK authentication form
    //
    public $vkRedirectURL = 'http://localhost/auth/vkLogin';

    public $vkClientId = '7481791';

    public $vkClientSecret = 'OaqdUq3tgv8uMrn2zf7D';

    // 'secret_state_code' should be used in prod
    public $vkState = 'offline';
}
