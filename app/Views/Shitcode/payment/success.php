...
<head>
	...
	<title>Платеж совершен!</title>
	<style>
		body {background: #f8f8f8; font-family: Arial; margin: 0; padding: 0; color: #000; font-size: 13px;}
		.main {height: 400px; width: 450px; margin: 150px auto 0 auto; position: relative; background: #f8f8f8 url('/static/payment_bg_success.jpg') bottom no-repeat;}
		h1 {font-size: 40px; margin: 15px 10px; line-height: 40px; color: #00CE00;}
