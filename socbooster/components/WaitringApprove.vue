                        ...
                        <tr v-for="(task, index) in tasks.data">
                            ...
                            <td>
                                <div class="d-inline-flex align-items-center">
                                    <span v-bind:class="StatusTaskClass(task.join_status.name)" data-toggle="dropdown">{{task.join_status.description}}</span>
                                </div>
                            </td>
                            <td>
                                <div class="font-weight-semibold">NO</div>
                            </td>
                        </tr>
                        </tbody>
                    </table>
        ...
        methods: {
            ...
            StatusTaskClass: function (id) {
                return {
                    ...
                    'badge bg-success': id == 'Auto assigned',
                    'badge bg-danger': id == 'Task rejected',
                }
            },
            fetchData() {
                // request to backend
                axios.get('/api/getwaitringapprove/')
                    .then((res) => {
                        this.tasks = res.data;
                        this.loading = false;
